...
//        }
    ...
    private static String genValue(){
        ...
        jo.put("score",getScore());
        jo.put("name",getFullName());
        return jo.toJSONString();
    }
    private static String getSubject(){
        String subjects[] = new String[]{
                "Hadoop","Spark","Flink","Java","C++"
        };
    ...
    private static double getScore(){
        double[] scores = new double[]{
                90,91.5,99,98,93,89,88.5,89,100,79,78.5,98.5
        };
    ...
    private static String getFullName() {
        ...
        String fullName = (i == 0 ? dan[xingIndex] : fu[xingIndex]) + ming[mingIndex];
        return fullName;
    }
